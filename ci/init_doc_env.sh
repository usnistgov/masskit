...
conda install -y -c pytorch -c conda-forge --override-channels sphinx myst-parser nbsphinx awscli boto3 hydra-core rdkit scikit-learn mlflow pytorch-lightning torchvision imageio jsonpickle torchmetrics
