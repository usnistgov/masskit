...
from massspec.peptide.encoding import calc_ions_mz, mod_sites, mod_masses
from massspec.spectrum.theoretical_spectrum import TheoreticalPeptideSpectrum
...
def add_theoretical_spectra(df, theoretical_spectrum_column=None, ion_types=None):
    """
